...
\begin{itemize}
	\item \textbf{Peng J}, Li H, Wang Y and Chen J, \emph{A web tool for measuring gene semantic similarities by combining Gene Ontology and gene co-function networks}, proceedings of the 6th ACM Conference on Bioinformatics, Computational Biology (ACM BCBÕ15), 2015, in press.
%
